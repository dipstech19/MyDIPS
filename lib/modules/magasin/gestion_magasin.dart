  ...
  Future<void> _appliquerMouvement(Mouvement m, {required bool annuler}) async {
    ...
    if (!produit.aVariantes) {
      await prodDoc.update({
        'quantiteStock': (produit.quantiteStock + signe * m.quantite).clamp(
          0,
          999999,
        ),
        'updatedAt': FieldValue.serverTimestamp(),
        ...
        children: [
          _TopNavBar(
            ...
            statChips: [
              if (_tab == 0) ...[
                _StatChip(
                  '${magasin.produits.length} produits',
                  kBlueLt,
                  kBlue,
                ),
                if (rupt > 0)
                  _StatChip(
                    '$rupt rupture${rupt > 1 ? "s" : ""}',
                    kRedLt,
                    kRed,
                  ),
            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(9),
                  border: sel
                      ? Border.all(color: col.withOpacity(0.3), width: 1.5)
                      : null,
                ),
                child: Row(
          ...
          child: list.isEmpty
            ...
            itemBuilder: (ctx, i) => _ProduitCard(
              ...
              onTap: () => _showDialog(
                ...
                _DetailsDialog(
                  produit: list[i],
                  groupe: groupeByLabel(list[i].groupeUniteLabel),
                ),
              ),
            ),
          )
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _PillBadge('Mag. ${p.magasin}', kIndigoLt, kIndigo),
                          ],
                        ),
                      ],
                    ),
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: list.isEmpty
              ? _EmptyState(
            message: 'Aucune entrée — cliquez sur « Nouvelle entrée »',
            color: kGreen,
          )
              : mobile
              ? ListView.separated(
            ...
            itemBuilder: (ctx, i) => _MouvCard(
              ...
              onDelete: () => _showDialog(
                ...
                _ConfirmDel(
                  ...
                  msg:
                  'Supprimer cette entrée ? Le stock sera décrémenté.',
                  onConfirm: () {
                    widget.magasin.deleteEntree(list[i].id);
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: list.isEmpty
              ? _EmptyState(
            message: 'Aucune sortie — cliquez sur « Nouvelle sortie »',
            color: kOrange,
          )
              : mobile
              ? ListView.separated(
            ...
            itemBuilder: (ctx, i) => _MouvCard(
              ...
              onDelete: () => _showDialog(
                ...
                _ConfirmDel(
                  ...
                  onConfirm: () {
                    widget.magasin.deleteSortie(list[i].id);
                    Navigator.of(ctx, rootNavigator: true).pop();
                  },
                ),
              ),
              ...
              rows: list
                  ...
                  onDelete: () => _showDialog(
                    ...
                    _ConfirmDel(
                      nom: m.nomProduit,
                      msg:
                      'Supprimer cette sortie ? Le stock sera restitué.',
                      onConfirm: () {
              ...
              mobile
                ...
                children: [
                  ...
                  _TypeToggleRow(
                    ...
                    onChanged: (v) => setState(() => _typeFiltre = v),
                  ),
                  const SizedBox(height: 8),
                  _GlassDropdown(
                    value: _mag,
              ...
              Wrap(
                ...
                children: [
                  ...
                  if (_dateDebut != null || _dateFin != null)
                    InkWell(
                      onTap: () => setState(() => _dateDebut = _dateFin = null),
                      borderRadius: BorderRadius.circular(7),
                      child: Container(
...
class _MouvFormState extends State<_MouvForm> {
  ...
  void _validateStock() {
    ...
    if (!_hasVar) {
      ...
      setState(
            () => _stockError = demande > _selProd!.total
  ...
  bool get _hasStockError => !_isSortie
      ? false
      : (!_hasVar ? _stockError != null : _varStockErrors.isNotEmpty);
    ...
    try {
      ...
      if (scaffoldCtx != null && scaffoldCtx.mounted) {
        ScaffoldMessenger.of(scaffoldCtx).showSnackBar(
          SnackBar(
            content: Text(
              _isSortie ? 'Sortie enregistrée' : 'Entrée enregistrée',
            ),
  ...
  Future<void> _showPreneurDialog(BuildContext context) async {
    ...
    final activeEmployes = employeesProv.employes
        .where((e) => e.statut == EmployeStatut.enService)
        .toList()
      ..sort((a, b) => a.nom.compareTo(b.nom));

    final postes = activeEmployes
        .map((e) => e.poste.trim())
    ...
    if (!employeesProv.firebaseAvailable) {
      await showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Text('Firebase غير متاح حالياً.'),
          actions: [
            TextButton(
      ...
      builder: (dialogCtx) => StatefulBuilder(
        builder: (dialogCtx, setStateD) {
          ...
          final filtered = hasAnyFilter
              ? activeEmployes.where((e) {
                  final matchesName = e.nom.trim().toLowerCase().contains(qLower);
                  final matchesPoste = selectedPosteLower == null ||
                      e.poste.trim().toLowerCase() == selectedPosteLower;
            ...
            content: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    height: 320,
                    child: activeEmployes.isEmpty
                        ? const Center(
                            child: Text('Aucun employé en service'),
                          )
                        : !hasAnyFilter
                            ? const Center(
                                child: Text('Choisissez un nom ou un poste'),
                              )
                        : filtered.isEmpty
                            ? const Center(
  ...
  Widget build(BuildContext context) {
    ...
    return _FullDialog(
      ...
      saveLabel: _saving
          ? 'Enregistrement…'
          : (_isSortie ? 'Valider la sortie' : "Valider l'entrée"),
      saving: _saving,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            '🏪',
                            style: TextStyle(fontSize: mobile ? 18 : 22),
                          ),
                          ...
                          Text(
                            '$prodCount prod.',
                            style: _muted.copyWith(fontSize: 9),
                          ),
                          if (sel) ...[
          ...
          if (_selMag != null) ...[
            ...
            if (_selCat != null || _newCatMode) ...[
              ...
              if (_selProd != null || _newProdMode) ...[
                ...
                _SectionHdr(
                  '4. Quantité',
                  _hasVar ? Icons.grid_view_rounded : Icons.tag_rounded,
                  _col,
                ),
                const SizedBox(height: 10),
                ...
                // FIX: width limité pour le champ quantité
                  ConstrainedBox(
                    constraints: BoxConstraints(
                      maxWidth: mobile ? double.infinity : 220,
                    ),
                    child: _NumStepField(
                      ctrl: _qteC,
                      color: _col,
                  ...
                  Wrap(
                    ...
                    children: _groupe!.unites.map((u) {
                      ...
                      int? disp;
                      if (_isSortie && _selProd != null) {
                        final vm = _selProd!.variantes.where(
                              (v) => v.unite == u,
                        );
...
class _VarQteTableState extends State<_VarQteTable> {
  ...
  Widget build(BuildContext context) {
    ...
    final total = widget.selVar.fold(
      0,
          (s, u) => s + (int.tryParse(widget.varCtrl[u]?.text ?? '0') ?? 0),
    );
    return Container(
      decoration: BoxDecoration(
        color: kSurface,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  flex: 2,
                  child: Text('UNITÉ', style: _label.copyWith(color: col)),
                ),
                const SizedBox(width: 10),
                Expanded(
                  flex: 5,
                  child: Text('QUANTITÉ', style: _label.copyWith(color: col)),
                ),
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              if (g != null)
                _DetCard(Icons.widgets_rounded, '${g.emoji} Mesures', g.label),
            ],
          ),
          const SizedBox(height: 14),
              ...
              children: p.variantes.map((v) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: kBg,
                    borderRadius: BorderRadius.circular(kR),
                    border: Border.all(color: vc.withOpacity(0.15)),
                  ),
                  child: Row(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(
                            ...
                            side: const BorderSide(color: kBorderMd),
                            padding: const EdgeInsets.symmetric(
                              vertical: 12,
                            ),
  ...
  Widget build(BuildContext context) => Center(
    child: Padding(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.inbox_rounded, size: 52, color: color.withOpacity(0.2)),
          const SizedBox(height: 12),
          Text(message, style: _muted, textAlign: TextAlign.center),
        ],
      ),
    ),
  );
  ...
  Widget build(BuildContext context) => InkWell(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: Colors.white.withOpacity(date != null ? 0.6 : 0.3),
      ...
      child: DropdownButton<String>(
        ...
        items: items
            .map(
              (v) => DropdownMenuItem(
            value: v,
            child: Text(labels?[v] ?? v, overflow: TextOverflow.ellipsis),
          ),
        )
            .toList(),
        onChanged: (v) => onChanged(v!),
    ...
    child: DropdownButtonHideUnderline(
      child: DropdownButton<T>(
        ...
        hint: hint != null
            ? Text(
          hint!,
          style: const TextStyle(fontSize: 12, color: kBorderMd),
        )
            : null,
        style: const TextStyle(
          fontSize: 12,
